"""
Fine-tuning script for IndicBERT on the 4-class threat classification task.
...
def train(
    dataset_path: str,
    output_dir: str = "checkpoints/indicbert-threat-v1",
    ...
    """
    Fine-tune IndicBERT for threat classification.
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Fine-tune IndicBERT for threat classification")
    parser.add_argument("--dataset", required=True, help="Path to unified CSV dataset")
    parser.add_argument("--output-dir", default="checkpoints/indicbert-threat-v1")
    parser.add_argument("--model", default="ai4bharat/indic-bert")
