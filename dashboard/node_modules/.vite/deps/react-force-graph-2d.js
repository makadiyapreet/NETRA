...
function index(kapsuleComponent, {
  ...
  return (0, import_react.forwardRef)((props, ref) => {
    const domEl = (0, import_react.useRef)();
    const comp = (0, import_react.useMemo)(() => {
      const configOptions = Object.fromEntries(initPropNames.filter((p2) => props.hasOwnProperty(p2)).map((prop) => [prop, props[prop]]));
    ...
    const _call = (0, import_react.useCallback)(
      (method2, ...args) => comp[method2] instanceof Function ? comp[method2](...args) : void 0,
      [comp]
    );
    const prevPropsRef = (0, import_react.useRef)({});
    Object.keys(omit(props, [...methodNames, ...initPropNames])).filter((p2) => prevPropsRef.current[p2] !== props[p2]).forEach((p2) => _call(p2, props[p2]));
    prevPropsRef.current = props;
    (0, import_react.useImperativeHandle)(ref, () => Object.fromEntries(methodNames.map((method2) => [method2, (...args) => _call(method2, ...args)])), [_call]);
    return import_react.default.createElement(wrapperElementType, {
      ref: domEl
    });
  });
}
function useEffectOnce(effect, useEffectFn = import_react.useEffect) {
...
function index2(_ref2) {
  ...
  return function KapsuleComp() {
    ...
    Object.entries(aliases).forEach(function(_ref4) {
      var _ref5 = _slicedToArray2(_ref4, 2), alias = _ref5[0], target = _ref5[1];
...
var _default = (function() {
  ...
  return _createClass2(_default11, [{
    ...
    value: function lookup(color2) {
      ...
      var n2 = typeof color2 === "string" ? colorStr2Int(color2) : rgb2Int.apply(void 0, _toConsumableArray2(color2));
      if (!n2) return null;
...
function L(n2, l2, u2, t3, i2, r2, o2, e2, f2, c5, a3) {
  var s2, h2, p2, v2, y3, _2, g2, m3 = t3 && t3.__k || w, b10 = l2.length;
  for (f2 = T(u2, l2, m3, f2, b10), s2 = 0; s2 < b10; s2++) null != (p2 = u2.__k[s2]) && (h2 = -1 != p2.__i && m3[p2.__i] || d, p2.__i = s2, _2 = q(n2, p2, h2, i2, r2, o2, e2, f2, c5, a3), v2 = p2.__e, p2.ref && h2.ref != p2.ref && (h2.ref && J(h2.ref, null, p2), a3.push(p2.ref, p2.__c || v2, p2)), null == y3 && null != v2 && (y3 = v2), (g2 = !!(4 & p2.__u)) || h2.__k === p2.__k ? (f2 = j(p2, f2, n2, g2), g2 && h2.__e && (h2.__e = null)) : "function" == typeof p2.type && void 0 !== _2 ? f2 = _2 : v2 && (f2 = v2.nextSibling), p2.__u &= -7);
  return u2.__e = y3, f2;
}
function T(n2, l2, u2, t3, i2) {
  var r2, o2, e2, f2, c5, a3 = u2.length, s2 = a3, h2 = 0;
  for (n2.__k = new Array(i2), r2 = 0; r2 < i2; r2++) null != (o2 = l2[r2]) && "boolean" != typeof o2 && "function" != typeof o2 ? ("string" == typeof o2 || "number" == typeof o2 || "bigint" == typeof o2 || o2.constructor == String ? o2 = n2.__k[r2] = x(null, o2, null, null, null) : g(o2) ? o2 = n2.__k[r2] = x(S, { children: o2 }, null, null, null) : void 0 === o2.constructor && o2.__b > 0 ? o2 = n2.__k[r2] = x(o2.type, o2.props, o2.key, o2.ref ? o2.ref : null, o2.__v) : n2.__k[r2] = o2, f2 = r2 + h2, o2.__ = n2, o2.__b = n2.__b + 1, e2 = null, -1 != (c5 = o2.__i = O(o2, u2, f2, s2)) && (s2--, (e2 = u2[c5]) && (e2.__u |= 2)), null == e2 || null == e2.__v ? (-1 == c5 && (i2 > a3 ? h2-- : i2 < a3 && h2++), "function" != typeof o2.type && (o2.__u |= 4)) : c5 != f2 && (c5 == f2 - 1 ? h2-- : c5 == f2 + 1 ? h2++ : (c5 > f2 ? h2-- : h2++, o2.__u |= 4))) : n2.__k[r2] = null;
  if (s2) for (r2 = 0; r2 < a3; r2++) null != (e2 = u2[r2]) && 0 == (2 & e2.__u) && (e2.__e == t3 && (t3 = $(e2)), K(e2, e2));
  return t3;
}
...
function O(n2, l2, u2, t3) {
  var i2, r2, o2, e2 = n2.key, f2 = n2.type, c5 = l2[u2], a3 = null != c5 && 0 == (2 & c5.__u);
  if (null === c5 && null == e2 || a3 && e2 == c5.key && f2 == c5.type) return u2;
  if (t3 > (a3 ? 1 : 0)) {
...
function N(n2, l2, u2, t3, i2) {
  ...
  else if ("o" == l2[0] && "n" == l2[1]) r2 = l2 != (l2 = l2.replace(s, "$1")), o2 = l2.toLowerCase(), l2 = o2 in n2 || "onFocusOut" == l2 || "onFocusIn" == l2 ? o2.slice(2) : l2.slice(2), n2.l || (n2.l = {}), n2.l[l2 + r2] = u2, u2 ? t3 ? u2[a] = t3[a] : (u2[a] = h, n2.addEventListener(l2, r2 ? v : p, r2)) : n2.removeEventListener(l2, r2 ? v : p, r2);
  else {
...
function q(n2, u2, t3, i2, r2, o2, e2, f2, c5, a3) {
  ...
  } else null == o2 && u2.__v == t3.__v ? (u2.__k = t3.__k, u2.__e = t3.__e) : f2 = u2.__e = G(t3.__e, u2, t3, i2, r2, o2, e2, c5, a3);
...
function G(u2, t3, i2, r2, o2, e2, f2, c5, a3) {
  ...
  if ("svg" == x3 ? o2 = "http://www.w3.org/2000/svg" : "math" == x3 ? o2 = "http://www.w3.org/1998/Math/MathML" : o2 || (o2 = "http://www.w3.org/1999/xhtml"), null != e2) {
    for (s2 = 0; s2 < e2.length; s2++) if ((y3 = e2[s2]) && "setAttribute" in y3 == !!x3 && (x3 ? y3.localName == x3 : 3 == y3.nodeType)) {
      u2 = y3, e2[s2] = null;
      break;
    }
  }
  ...
  if (null == x3) m3 === k2 || c5 && u2.data == k2 || (u2.data = k2);
    ...
    if (e2 = "textarea" == x3 && null != k2.defaultValue ? null : e2 && n.call(u2.childNodes), !c5 && null != e2) for (m3 = {}, s2 = 0; s2 < u2.attributes.length; s2++) m3[(y3 = u2.attributes[s2]).name] = y3.value;
    ...
    else if (p2 && (u2.innerHTML = ""), L("template" == t3.type ? u2.content : u2, g(v2) ? v2 : [v2], t3, i2, r2, "foreignObject" == x3 ? "http://www.w3.org/1999/xhtml" : o2, e2, f2, e2 ? e2[0] : i2.__k && $(i2, 0), c5, a3), null != e2) for (s2 = e2.length; s2--; ) b(e2[s2]);
    ...
    (function flatten2(node) {
      ...
      if (accKeys.length === keys2.length) {
        ...
        Object.entries(node).forEach(function(_ref2) {
          ...
          return flatten2(val, [].concat(_toConsumableArray3(accKeys), [key]));
        });
      }
    })(indexedResult);
  ...
  function traverse(nodes2) {
    ...
    var _loop = function _loop2() {
      ...
      if (nodeStack.indexOf(node) !== -1) {
        var loop = [].concat(_toConsumableArray4(nodeStack.slice(nodeStack.indexOf(node))), [node]).map(function(d2) {
...
var updDataPhotons = function updDataPhotons2(_2, state) {
  if (!state.isShadow) {
    ...
    state.graphData.links.forEach(function(link) {
      ...
      if (numPhotons) {
        link.__photons = _toConsumableArray4(Array(numPhotons)).map(function() {
          return {};
        });
      } else {
    ...
    tickFrame: function tickFrame(state) {
      ...
      function paintLinks() {
        ...
        if (state.linkCanvasObject) {
          ...
          defaultPaintLinks = [].concat(_toConsumableArray4(beforeCustomLinks), afterCustomLinks, otherCustomLinks);
            ...
            Object.entries(linesPerLineDash).forEach(function(_ref5) {
              ...
              links.forEach(function(link) {
                ...
                if (!controlPoints) {
                  ...
                  ctx[controlPoints.length === 2 ? "quadraticCurveTo" : "bezierCurveTo"].apply(ctx, _toConsumableArray4(controlPoints).concat([end.x, end.y]));
                }
              });
      ...
      function paintArrows() {
        ...
        state.graphData.links.filter(getVisibility).forEach(function(link) {
          ...
          var bzLine = link.__controlPoints && _construct(Bezier, [start2.x, start2.y].concat(_toConsumableArray4(link.__controlPoints), [end.x, end.y]));
      ...
      function paintPhotons() {
        ...
        state.graphData.links.filter(getVisibility).forEach(function(link) {
          ...
          var bzLine = link.__controlPoints ? _construct(Bezier, [start2.x, start2.y].concat(_toConsumableArray4(link.__controlPoints), [end.x, end.y])) : null;
...
})).concat(_toConsumableArray4(["nodeRelSize", "nodeId", "nodeVal", "nodeVisibility", "linkSource", "linkTarget", "linkVisibility", "linkCurvature"].map(function(p2) {
  return _defineProperty3({}, p2, bindBoth.linkProp(p2));
}))));
var linkedMethods = Object.assign.apply(Object, _toConsumableArray4(["d3Force", "d3ReheatSimulation", "emitParticle"].map(function(p2) {
